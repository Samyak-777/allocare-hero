...
export const Route = createFileRoute("/tech")({
  head: () => ({
    meta: [
      { title: "Tech Stack — AlloCare" },
      { name: "description", content: "Google AI, Google Maps, Gemini, Cloud Vision, Firebase, Vertex AI, BigQuery — every Google technology in the AlloCare stack." },
      { property: "og:title", content: "Tech Stack — AlloCare" },
      { property: "og:description", content: "All Google. End to end." },
    ],
  }),
  component: TechPage,
});
...
const STACK = [
  ...
  { name: "Firebase Auth", use: "Google Sign-In for NGO coordinators", critical: "Zero-friction auth" },
