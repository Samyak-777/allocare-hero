...
export const Route = createFileRoute("/features")({
  head: () => ({
    meta: [
      { title: "Features — AlloCare" },
      { name: "description", content: "Multi-source ingestion, Gemini urgency scoring, Google Maps heatmap, smart volunteer matching, coordinator dashboard, mobile task feed, gamified scorecards." },
      { property: "og:title", content: "Features — AlloCare" },
      { property: "og:description", content: "F1–F12: every capability in the AlloCare platform." },
    ],
  }),
