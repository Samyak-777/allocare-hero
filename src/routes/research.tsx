...
export const Route = createFileRoute("/research")({
  head: () => ({
    meta: [
      { title: "Research — AlloCare" },
      { name: "description", content: "Peer-reviewed papers and field studies that shape the AlloCare architecture." },
      { property: "og:title", content: "Research — AlloCare" },
      { property: "og:description", content: "Evidence-grounded humanitarian AI." },
    ],
  }),
