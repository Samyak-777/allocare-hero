...
export const Route = createFileRoute("/how-it-works")({
  head: () => ({
    meta: [
      { title: "How It Works — AlloCare" },
      { name: "description", content: "Two end-to-end flows: NGO coordinator ingesting a paper survey, and a volunteer accepting and completing a task." },
      { property: "og:title", content: "How It Works — AlloCare" },
      { property: "og:description", content: "From paper to deployed volunteer in two flows." },
    ],
  }),
