...
export const Route = createFileRoute("/problem")({
  head: () => ({
    meta: [
      { title: "The Problem — AlloCare" },
      { name: "description", content: "NGO need-data is undigitized, siloed, and matched manually. AlloCare closes the loop from problem to deployed volunteer." },
      { property: "og:title", content: "The Problem — AlloCare" },
      { property: "og:description", content: "Three compounding failures keep humanitarian resources misaligned. Here's how AlloCare fixes them." },
    ],
  }),
